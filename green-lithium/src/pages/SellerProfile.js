...
export default function SellerProfile() {
    var _this = this;
    var sellerId = useParams().sellerId;
    var _a = useState(null), seller = _a[0], setSeller = _a[1];
    var _b = useState(true), loading = _b[0], setLoading = _b[1];
    var _c = useState(""), error = _c[0], setError = _c[1];
    useEffect(function () {
        var fetchSeller = function () { return __awaiter(_this, void 0, void 0, function () {
            var response, data, err_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, 4, 5]);
                        return [4 /*yield*/, fetch("/api/seller/".concat(sellerId, "/"))];
                    case 1:
                        response = _a.sent();
                        if (!response.ok) {
