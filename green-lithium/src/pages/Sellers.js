...
export default function Sellers() {
    var _this = this;
    var _a = useState([]), sellers = _a[0], setSellers = _a[1];
    var _b = useState(true), loading = _b[0], setLoading = _b[1];
    var _c = useState(""), error = _c[0], setError = _c[1];
    var navigate = useNavigate();
    useEffect(function () {
        var fetchSellers = function () { return __awaiter(_this, void 0, void 0, function () {
            var response, data, err_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, 4, 5]);
                        return [4 /*yield*/, fetch("/api/seller/list/")];
                    case 1:
                        response = _a.sent();
                        if (!response.ok) {
    ...
    return (_jsxs("div", { className: "sellers-container", children: [_jsx("h2", { className: "sellers-title", children: "Sellers" }), _jsx("p", { className: "sellers-subtitle", children: "Discover verified lithium manufacturers and suppliers." }), loading && _jsx("p", { className: "loading-text", children: "Loading sellers..." }), error && _jsx("p", { className: "error-text", children: error }), _jsxs("div", { className: "sellers-grid", children: [sellers.map(function (seller) { return (_jsxs("div", { className: "seller-card", style: { cursor: "pointer" }, onClick: function () { return navigate("/seller/".concat(seller.id)); }, children: [_jsx("div", { className: "seller-avatar", children: seller.company_name
